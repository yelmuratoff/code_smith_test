  ...
  Widget _parseMap({
    ...
    if (data.entries.isEmpty) {
      ...
      for (int i = 0; i < data.entries.length; i++) {
        final String jKey = data.entries.toList()[i].key.toString();
              ...
              TextSpan(
                children: [
                  ...
                  if (jsonKey != null)
                    TextSpan(
                      text: ' : ',
                      style: TextStyle(color: _globalColonColor),
                    ),
                  TextSpan(
                    text: jsonValue,
                  ...
                  if (showComma)
                    TextSpan(
                      text: ',',
                      style: TextStyle(color: _globalCommaColor),
                    ),
                ],
              ),
            ),
...
String _spaces(int multiple) => ' ' * _globalTabLength * multiple;
